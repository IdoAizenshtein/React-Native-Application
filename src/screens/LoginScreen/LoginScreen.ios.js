...
import {ALERTS_TRIAL, BASE_URL, HOST, HOSTS, IS_DEV, setDevModeFunc, setLocalModeFunc, ReCaptchaV3Var} from '../../constants/config'
...
// smsSubscription = null
    ...
    handleLoginSubmit = () => {
        const {username, password, inProgress, rememberMeState, gRecaptcha,} = this.state
        const {dispatch} = this.props
        const re = /\S+@\S+\.\S+/
            ...
            <ScrollView
                ...
                <ReCaptchaV3
                  ...
                  onReceiveToken={(token) => {
                      ...
                      // console.log(ReCaptchaV3Var)
                      // if(ReCaptchaV3Var.func.action){
                      //     console.log(ReCaptchaV3Var.func.action)
                      //     this.setState({gRecaptcha: token})
                      // }
                  }}
                />
