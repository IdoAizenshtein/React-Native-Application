        ...
        <View style={styles.cardWrapper}>
          {isDragged ? (
            <View style={styles.draggableCardInner}>
              <CustomIcon name={getTransCategoryIcon(category.iconType)}
                          size={24} color={colors.blue8}/>
              <Text style={styles.draggableCardText}
                    numberOfLines={1}>{category.transTypeName}</Text>
            </View>
          ) : (
            <View pointerEvents="none" style={commonStyles.alignItemsCenter}>
              <View style={cs(isSelected, styles.cardInner,
                styles.cardInnerSelected)}>
                <CustomIcon name={getTransCategoryIcon(category.iconType)}
                            size={35}
                            color={colors.blue8}/>
              </View>
